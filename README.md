...
- Vamos clonar meu repositório
 ```git clone https://github.com/Yago-Pimenta/CompiladoresT1.git```

 - Precisamos compilar o projeto : abrir a pasta do t1 no terminal e digitar
...
- Vamos criar um diretório específico para ele ao lado do meu t1 , finalmente podemos rodar meu corretor

  ```java -jar compiladores-corretor-automatico-1.0-SNAPSHOT-jar-with-dependencies.jar "java -jar ../MeuLexico/target/MeuLexer-1.0-SNAPSHOT-jar-with-dependencies.jar" gcc temp casos-de-teste "800273" t1```
- Lembrando que o 800273 deve ser substituído pelo RA respectivo do aluno

- Eu não consegui tirar 37 de 37 , minha nota ficou 29/37
